 ...
 * @param {string} opts.coin[='polis'] - The coin for this wallet (polis, bch).
 ...
 * @param {string} opts.coin[='polis'] - The expected coin for this wallet (polis, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['polis', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='polis'] (optional)
    ...
    self._getUtxosForCurrentWallet({}, function(err, utxos) {
      ...
      var info = {
       ...
       if(opts.isInstantSend===true){
        ...
        if(!validUTXO)
            return cb(new Error('InstantSend requires all Polis you are sending (transaction inputs) to be held for about 15-20 minutes (minimum 6 network confirmations). Please wait before using InstantSend.'));
       }
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'polis'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
<<<<<<< HEAD
 * @param {string} [opts.network = 'livenet'] - The Polis network for this transaction.
=======
 * @param {string} [opts.coin = 'polis'] - The coin for this transaction.
