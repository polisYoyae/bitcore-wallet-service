...
describe('#AddressTranslator', function() {
  ...
  it('should keep the address if there is nothing to do (polis)', function() {
    var res = AddressTranslator.translate('XqHSiRAXd3EmNUPCAqok6ch5XzVWqKg7VD', 'polis');
  ...
  it('should support 3 params NOK', function() {
    ...
    var a;
    try {
      var res = AddressTranslator.translate('XqHSiRAXd3EmNUPCAqok6ch5XzVWqKg7VD', 'polis', 'bch');
    } catch (e) {
      a=e.toString();
  ...
  it('should support 3 params OK', function() {
    var res = AddressTranslator.translate('HBf8isgS8EXG1r3X6GP89FmooUmiJ42wHS', 'polis', 'bch');
    assert(res=='7XYf6GXX5uQEPShSWCPUWFEvhNb5Ez2JrE');
  });
