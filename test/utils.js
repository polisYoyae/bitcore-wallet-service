...
describe('Utils', function() {
  ...
  describe('#getAddressCoin', function() {
    it('should identify polis as coin for XqHSiRAXd3EmNUPCAqok6ch5XzVWqKg7VD', function() {
      Utils.getAddressCoin('XqHSiRAXd3EmNUPCAqok6ch5XzVWqKg7VD').should.equal('polis');
    });
  ...
  describe('#translateAddress', function() {
    ...
    it('should translate address from bch to polis', function() {
      var res = Utils.translateAddress('HBf8isgS8EXG1r3X6GP89FmooUmiJ42wHS', 'polis');
    ...
    it('should keep the address if there is nothing to do (polis)', function() {
      var res = Utils.translateAddress('XqHSiRAXd3EmNUPCAqok6ch5XzVWqKg7VD', 'polis');
      should.exist(res);
